  ...
  return (
    <>
...

      {
        ...
        return (
          <>
            <Card style={{ width: "20rem", border:"none", border: "none"}}
            className="mx-2 mt-4 card_style" >
              {/* <Card.Img variant="top" src={mob.img} style = {{height: 300, width: 200, margin: 30}}/> */}
              <Card.Img variant="top" src={lap.img}  style = {{height: "10rem", width: "15rem", margin: 20, border: "nonne", }}
                className = "mt-3"
              />
              <Card.Body>
                <Card.Title style = {{textAlign : "center"}}>{lap.name}</Card.Title>
